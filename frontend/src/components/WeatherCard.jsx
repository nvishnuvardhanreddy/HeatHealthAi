  ...
  return (
    <div className="glass-panel p-6 flex flex-col justify-between">
      <div className="flex items-center justify-between mb-4">
        <div>
          <span className="text-[11px] font-mono uppercase tracking-wider text-slate-400">Meteorological Observation</span>
          <h3 className="text-base font-bold text-white">Current Weather Conditions</h3>
        </div>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 my-2">
        ...
        <div className="p-3.5 rounded-xl bg-slate-900/80 border border-slate-800 flex flex-col justify-between">
          ...
          <div className="text-[10px] text-slate-500 mt-0.5 font-mono">Relative Humidity</div>
        </div>
        ...
        <div className="p-3.5 rounded-xl bg-slate-900/80 border border-slate-800 flex flex-col justify-between">
          ...
          <div className="text-[10px] text-slate-500 mt-0.5 font-mono">10m Surface Convection</div>
        </div>
        ...
        <div className="p-3.5 rounded-xl bg-slate-900/80 border border-slate-800 flex flex-col justify-between">
          ...
          <div className="text-[10px] text-slate-500 mt-0.5 font-mono">Direct Irradiance</div>
        </div>
      </div>
